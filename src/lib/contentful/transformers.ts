...
/**
 * Extract image dimensions from Contentful Asset
 */
...
export const transformProject = (
  ...
  const { width: imageWidth, height: imageHeight } =
    getImageDimensions(imageAsset);

  return {
    id: entry.sys.id,
    title: fields.title as string,
    description: fields.description as string,
    image: getImageUrl(imageAsset),
    imageWidth,
    imageHeight,
    tags,
...
export const transformCertificate = (
  ...
  return {
    ...
    year: String(fields.year as number),
...
export const transformExperience = (
  ...
  return {
    ...
    iscurrent: (fields.isCurrent as boolean | undefined) || false,
...
export const transformProfile = (
  ...
  return {
    ...
    resume: getImageUrl(fields.resume as Asset | undefined),
  };
};
